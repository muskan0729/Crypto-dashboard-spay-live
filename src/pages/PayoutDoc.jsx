...
const PayoutDoc = () => {
  ...
  const CASHFREE_SECTIONS = [/* unchanged data */];
  const BUSYBOX_SECTIONS = [/* unchanged data */];
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl p-4">
                ...
                <p className="text-xs text-red-300 mt-2">
                  Callback failure is sent after timeout if payment
                  remains incomplete.
                </p>
              </div>
            </div>
  ...
  return (
    <div className="bg-black min-h-screen flex">
      ...
      <aside className="w-72 bg-white/5 backdrop-blur-xl border-r border-white/10 shadow-xl p-4 hidden md:block">
        <h2 className="text-[#ffd700] font-bold mb-4">
          API Documentation
        </h2>
            ...
            <button
              ...
              className={`w-full text-left px-4 py-2 rounded-xl transition ${
                activeSection === section.id
                  ? "bg-gradient-to-r from-yellow-400/20 via-orange-400/20 to-red-400/20 text-[#ffd700]"
